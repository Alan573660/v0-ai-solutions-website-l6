...
export type TranslationKey =
  ...
  | "homepage.badge"
  | "homepage.title"
  | "homepage.titleHighlight"
  | "homepage.subtitle"
  | "homepage.ctaPrimary"
  | "homepage.ctaSecondary"
  | "homepage.trustText"
  | "homepage.stat1.value"
  | "homepage.stat1.label"
  | "homepage.stat2.value"
  | "homepage.stat2.label"
  | "homepage.stat3.value"
  | "homepage.stat3.label"
  | "homepage.stat4.value"
  | "homepage.stat4.label"
  | "homepage.integrations"
  | "homepage.solutionsLabel"
  | "homepage.solutionsTitle"
  | "homepage.solutionsDesc"
  | "homepage.processLabel"
  | "homepage.processTitle"
  | "homepage.processDesc"
  | "homepage.step1.title"
  | "homepage.step1.desc"
  | "homepage.step1.dur"
  | "homepage.step2.title"
  | "homepage.step2.desc"
  | "homepage.step2.dur"
  | "homepage.step3.title"
  | "homepage.step3.desc"
  | "homepage.step3.dur"
  | "homepage.step4.title"
  | "homepage.step4.desc"
  | "homepage.step4.dur"
  | "homepage.capabilitiesLabel"
  | "homepage.capabilitiesTitle"
  | "homepage.capabilitiesDesc"
  | "homepage.cap1.title"
  | "homepage.cap1.text"
  | "homepage.cap2.title"
  | "homepage.cap2.text"
  ...
  | "homepage.cap6.title"
  | "homepage.cap6.text"
  | "homepage.industriesLabel"
  | "homepage.industries"
  | "homepage.teamLabel"
  | "homepage.teamTitle"
  | "homepage.teamDesc"
  | "homepage.role1.title"
  | "homepage.role1.text"
  | "homepage.role2.title"
  | "homepage.role2.text"
  | "homepage.role3.title"
  | "homepage.role3.text"
  | "homepage.role4.title"
  | "homepage.role4.text"
  | "homepage.role5.title"
  | "homepage.role5.text"
  | "homepage.role6.title"
  | "homepage.role6.text"
  | "homepage.expertsLabel"
  | "homepage.demoLabel"
  | "homepage.demoTitle"
  | "homepage.demoDesc"
  | "homepage.resultLabel"
  | "homepage.testimonialsLabel"
  | "homepage.testimonialsTitle"
  | "homepage.testimonialsDesc"
  | "homepage.statsLabel"
  | "homepage.statsTitle"
  | "homepage.statsDesc"
  | "homepage.faqLabel"
...
const translations: Readonly<Record<Locale, Record<TranslationKey, string>>> = {
  ru: {
    ...
    "solutions.sales.feature3": "Созда��ие КП",
    ...
    "voiceSales.scenario3.dialogue1":
      "Добрый день! Меня зовут Анна. Вы недавно добавили тов��ры в корзину, но не завершили оформление. Могу помочь с заказом?",
    ...
    // Homepage
    "homepage.badge": "AI-решения для бизнеса нового поколения",
    "homepage.title": "Голосовые AI-менеджеры, которые ",
    "homepage.titleHighlight": "продают за вас",
    "homepage.subtitle": "Принимают звонки, обрабатывают заявки, формируют счета и ведут CRM. Без выходных, без больничных, без ошибок. 24/7/365.",
    "homepage.ctaPrimary": "Получить бесплатный аудит",
    "homepage.ctaSecondary": "Послушать AI в деле",
    "homepage.trustText": "Бесплатная консультация · Расчет ROI за 15 минут · Без обязательств",
    "homepage.stat1.value": "500+",
    "homepage.stat1.label": "Проектов реализовано",
    "homepage.stat2.value": "10+",
    "homepage.stat2.label": "Лет на рынке AI",
    "homepage.stat3.value": "+87%",
    "homepage.stat3.label": "Средний рост конверсии",
    "homepage.stat4.value": "98%",
    "homepage.stat4.label": "Клиентов довольны",
    "homepage.integrations": "Интеграции",
    "homepage.solutionsLabel": "Решения",
    "homepage.solutionsTitle": "AI-решения, которые уже зарабатывают деньги",
    "homepage.solutionsDesc": "Каждое решение проектируется под вашу отрасль, интегрируется с текущими системами и приносит измеримый результат",
    "homepage.processLabel": "Процесс",
    "homepage.processTitle": "От анализа до запуска за 2–4 недели",
    "homepage.processDesc": "Прозрачный процесс с четкими этапами. Вы видите прогресс на каждом шаге.",
    "homepage.step1.title": "Погружение",
    "homepage.step1.desc": "Глубокий анализ бизнес-процессов, выявление точек роста и изучение целевой аудитории",
    "homepage.step1.dur": "2–3 дня",
    "homepage.step2.title": "Архитектура",
    "homepage.step2.desc": "Разработка сценариев, выбор моделей, проектирование интеграций с инфраструктурой",
    "homepage.step2.dur": "3–5 дней",
    "homepage.step3.title": "Обучение AI",
    "homepage.step3.desc": "Составление промптов, обучение на ваших данных, настройка под тон бренда",
    "homepage.step3.dur": "5–7 дней",
    "homepage.step4.title": "Запуск",
    "homepage.step4.desc": "Пилот, A/B тесты, корректировка, полный деплой с мониторингом 24/7",
    "homepage.step4.dur": "2–3 дня",
    "homepage.capabilitiesLabel": "Возможности",
    "homepage.capabilitiesTitle": "Что умеет AI-менеджер M2",
    "homepage.capabilitiesDesc": "Модели последнего поколения, обученные специфике вашей отрасли",
    "homepage.cap1.title": "Формирование счетов",
    "homepage.cap1.text": "AI создает счета в PDF, распознает реквизиты и отправляет клиенту автоматически",
    "homepage.cap2.title": "Полная воронка продаж",
    "homepage.cap2.text": "Квалификация лидов, борьба с возражениями, презентация. Конверсия до +87%",
    "homepage.cap3.title": "Все каналы связи",
    "homepage.cap3.text": "Звонки, email, SMS, Telegram, WhatsApp. Единый агент на все каналы",
    "homepage.cap4.title": "Интеграция с CRM",
    "homepage.cap4.text": "amoCRM, Bitrix24, 1C, SAP. Синхронизация данных в реальном времени",
    "homepage.cap5.title": "Автоматизация закупок",
    "homepage.cap5.text": "AI формирует заказы поставщикам и отслеживает статус поставок",
    "homepage.cap6.title": "Обучение под бренд",
    "homepage.cap6.text": "AI перенимает тон, ценности и стандарты компании для каждого клиента",
    "homepage.industriesLabel": "Отрасли",
    "homepage.industries": "Строительство,Недвижимость,Умные дома,Госсектор,Банки,E-commerce,Медицина,Логистика",
    "homepage.teamLabel": "Команда",
    "homepage.teamTitle": "6 компаний в одной экосистеме",
    "homepage.teamDesc": "Полная команда специалистов под каждый проект",
    "homepage.role1.title": "Бизнес-консультанты",
    "homepage.role1.text": "Погружаются в бизнес, анализируют процессы, выявляют точки роста",
    "homepage.role2.title": "Бизнес-аналитики",
    "homepage.role2.text": "Переводят бизнес-задачи на технический язык, структурируют требования",
    "homepage.role3.title": "ML-инженеры",
    "homepage.role3.text": "Backend, frontend, DevOps, ML. Реализуют техническую часть решений",
    "homepage.role4.title": "Проектные менеджеры",
    "homepage.role4.text": "Координируют работу, следят за сроками и качеством. Единый контакт",
    "homepage.role5.title": "Техподдержка 24/7",
    "homepage.role5.text": "Круглосуточный мониторинг, быстрая реакция, непрерывные улучшения",
    "homepage.role6.title": "AI-тренеры",
    "homepage.role6.text": "Обучают модели специфике бизнеса, настраивают промпты и сценарии",
    "homepage.expertsLabel": "Ключевые эксперты",
    "homepage.demoLabel": "Демо",
    "homepage.demoTitle": "Послушайте AI-менеджера в деле",
    "homepage.demoDesc": "Настоящие записи звонков из разных отраслей",
    "homepage.resultLabel": "Результат",
    "homepage.testimonialsLabel": "Отзывы",
    "homepage.testimonialsTitle": "Что говорят клиенты",
    "homepage.testimonialsDesc": "Реальные результаты внедрения AI-решений",
    "homepage.statsLabel": "Результаты",
    "homepage.statsTitle": "Цифры говорят сами за себя",
    "homepage.statsDesc": "Измеримые результаты наших клиентов",
    "homepage.faqLabel": "FAQ",
    "homepage.faqTitle": "Частые вопросы",
    "homepage.faqDesc": "Ответы на популярные вопросы о внедрении AI",
    "homepage.finalCtaLabel": "Начните сейчас",
    "homepage.finalCtaTitle": "Готовы автоматизировать продажи?",
  ...
  en: {
    ...
    "hotelConcierge.ai": "AI",
    // Homepage
    "homepage.badge": "Next-generation AI solutions for business",
    "homepage.title": "Voice AI managers that ",
    "homepage.titleHighlight": "sell for you",
    "homepage.subtitle": "Handle calls, process leads, generate invoices, and manage CRM. No weekends, no sick days, no mistakes. 24/7/365.",
    "homepage.ctaPrimary": "Get free audit",
    "homepage.ctaSecondary": "Listen to AI in action",
    "homepage.trustText": "Free consultation · ROI calculation in 15 min · No obligations",
    "homepage.stat1.value": "500+",
    "homepage.stat1.label": "Projects completed",
    "homepage.stat2.value": "10+",
    "homepage.stat2.label": "Years in AI market",
    "homepage.stat3.value": "+87%",
    "homepage.stat3.label": "Average conversion growth",
    "homepage.stat4.value": "98%",
    "homepage.stat4.label": "Satisfied clients",
    "homepage.integrations": "Integrations",
    "homepage.solutionsLabel": "Solutions",
    "homepage.solutionsTitle": "AI solutions that already generate revenue",
    "homepage.solutionsDesc": "Each solution is designed for your industry, integrates with current systems, and delivers measurable results",
    "homepage.processLabel": "Process",
    "homepage.processTitle": "From analysis to launch in 2-4 weeks",
    "homepage.processDesc": "Transparent process with clear stages. You see progress at every step.",
    "homepage.step1.title": "Discovery",
    "homepage.step1.desc": "Deep analysis of business processes, identifying growth points and studying target audience",
    "homepage.step1.dur": "2-3 days",
    "homepage.step2.title": "Architecture",
    "homepage.step2.desc": "Scenario development, model selection, integration design with infrastructure",
    "homepage.step2.dur": "3-5 days",
    "homepage.step3.title": "AI Training",
    "homepage.step3.desc": "Creating prompts, training on your data, tuning to brand voice",
    "homepage.step3.dur": "5-7 days",
    "homepage.step4.title": "Launch",
    "homepage.step4.desc": "Pilot, A/B tests, adjustments, full deployment with 24/7 monitoring",
    "homepage.step4.dur": "2-3 days",
    "homepage.capabilitiesLabel": "Capabilities",
    "homepage.capabilitiesTitle": "What M2 AI Manager can do",
    "homepage.capabilitiesDesc": "Latest generation models trained for your industry specifics",
    "homepage.cap1.title": "Invoice generation",
    "homepage.cap1.text": "AI creates PDF invoices, recognizes details and sends to client automatically",
    "homepage.cap2.title": "Full sales funnel",
    "homepage.cap2.text": "Lead qualification, objection handling, presentation. Conversion up to +87%",
    "homepage.cap3.title": "All communication channels",
    "homepage.cap3.text": "Calls, email, SMS, Telegram, WhatsApp. Single agent for all channels",
    "homepage.cap4.title": "CRM integration",
    "homepage.cap4.text": "amoCRM, Bitrix24, 1C, SAP. Real-time data synchronization",
    "homepage.cap5.title": "Procurement automation",
    "homepage.cap5.text": "AI generates supplier orders and tracks delivery status",
    "homepage.cap6.title": "Brand training",
    "homepage.cap6.text": "AI adopts company tone, values and standards for each client",
    "homepage.industriesLabel": "Industries",
    "homepage.industries": "Construction,Real Estate,Smart Homes,Government,Banks,E-commerce,Healthcare,Logistics",
    "homepage.teamLabel": "Team",
    "homepage.teamTitle": "6 companies in one ecosystem",
    "homepage.teamDesc": "Complete team of specialists for each project",
    "homepage.role1.title": "Business consultants",
    "homepage.role1.text": "Dive into business, analyze processes, identify growth points",
    "homepage.role2.title": "Business analysts",
    "homepage.role2.text": "Translate business tasks into technical language, structure requirements",
    "homepage.role3.title": "ML engineers",
    "homepage.role3.text": "Backend, frontend, DevOps, ML. Implement technical solutions",
    "homepage.role4.title": "Project managers",
    "homepage.role4.text": "Coordinate work, monitor deadlines and quality. Single contact point",
    "homepage.role5.title": "24/7 Support",
    "homepage.role5.text": "Round-the-clock monitoring, fast response, continuous improvements",
    "homepage.role6.title": "AI trainers",
    "homepage.role6.text": "Train models for business specifics, configure prompts and scenarios",
    "homepage.expertsLabel": "Key experts",
    "homepage.demoLabel": "Demo",
    "homepage.demoTitle": "Listen to AI manager in action",
    "homepage.demoDesc": "Real call recordings from different industries",
    "homepage.resultLabel": "Result",
    "homepage.testimonialsLabel": "Testimonials",
    "homepage.testimonialsTitle": "What clients say",
    "homepage.testimonialsDesc": "Real results of AI solutions implementation",
    "homepage.statsLabel": "Results",
    "homepage.statsTitle": "Numbers speak for themselves",
    "homepage.statsDesc": "Measurable results from our clients",
    "homepage.faqLabel": "FAQ",
    "homepage.faqTitle": "Frequently asked questions",
    "homepage.faqDesc": "Answers to popular questions about AI implementation",
    "homepage.finalCtaLabel": "Start now",
    "homepage.finalCtaTitle": "Ready to automate sales?",
  ...
  es: {
    ...
    // Homepage
    "homepage.badge": "Soluciones IA de nueva generación para negocios",
    "homepage.title": "Gestores de IA por voz que ",
    "homepage.titleHighlight": "venden por ti",
    "homepage.subtitle": "Atienden llamadas, procesan solicitudes, generan facturas y gestionan CRM. Sin fines de semana, sin bajas, sin errores. 24/7/365.",
    "homepage.ctaPrimary": "Obtener auditoría gratuita",
    "homepage.ctaSecondary": "Escuchar IA en acción",
    "homepage.trustText": "Consulta gratuita · Cálculo ROI en 15 min · Sin compromiso",
    "homepage.stat1.value": "500+",
    "homepage.stat1.label": "Proyectos completados",
    "homepage.stat2.value": "10+",
    "homepage.stat2.label": "Años en el mercado IA",
    "homepage.stat3.value": "+87%",
    "homepage.stat3.label": "Crecimiento promedio conversión",
    "homepage.stat4.value": "98%",
    "homepage.stat4.label": "Clientes satisfechos",
    "homepage.integrations": "Integraciones",
    "homepage.solutionsLabel": "Soluciones",
    "homepage.solutionsTitle": "Soluciones IA que ya generan ingresos",
    "homepage.solutionsDesc": "Cada solución se diseña para tu industria, se integra con sistemas actuales y ofrece resultados medibles",
    "homepage.processLabel": "Proceso",
    "homepage.processTitle": "Del análisis al lanzamiento en 2-4 semanas",
    "homepage.processDesc": "Proceso transparente con etapas claras. Ves el progreso en cada paso.",
    "homepage.step1.title": "Inmersión",
    "homepage.step1.desc": "Análisis profundo de procesos de negocio, identificación de puntos de crecimiento y estudio del público objetivo",
    "homepage.step1.dur": "2-3 días",
    "homepage.step2.title": "Arquitectura",
    "homepage.step2.desc": "Desarrollo de escenarios, selección de modelos, diseño de integraciones con infraestructura",
    "homepage.step2.dur": "3-5 días",
    "homepage.step3.title": "Entrenamiento IA",
    "homepage.step3.desc": "Creación de prompts, entrenamiento con tus datos, ajuste al tono de marca",
    "homepage.step3.dur": "5-7 días",
    "homepage.step4.title": "Lanzamiento",
    "homepage.step4.desc": "Piloto, pruebas A/B, ajustes, despliegue completo con monitoreo 24/7",
    "homepage.step4.dur": "2-3 días",
    "homepage.capabilitiesLabel": "Capacidades",
    "homepage.capabilitiesTitle": "Qué puede hacer el gestor IA M2",
    "homepage.capabilitiesDesc": "Modelos de última generación entrenados para tu industria",
    "homepage.cap1.title": "Generación de facturas",
    "homepage.cap1.text": "IA crea facturas PDF, reconoce datos y envía al cliente automáticamente",
    "homepage.cap2.title": "Embudo de ventas completo",
    "homepage.cap2.text": "Calificación de leads, manejo de objeciones, presentación. Conversión hasta +87%",
    "homepage.cap3.title": "Todos los canales",
    "homepage.cap3.text": "Llamadas, email, SMS, Telegram, WhatsApp. Un agente para todos los canales",
    "homepage.cap4.title": "Integración CRM",
    "homepage.cap4.text": "amoCRM, Bitrix24, 1C, SAP. Sincronización de datos en tiempo real",
    "homepage.cap5.title": "Automatización de compras",
    "homepage.cap5.text": "IA genera pedidos a proveedores y rastrea estado de entregas",
    "homepage.cap6.title": "Entrenamiento de marca",
    "homepage.cap6.text": "IA adopta tono, valores y estándares de la empresa para cada cliente",
    "homepage.industriesLabel": "Industrias",
    "homepage.industries": "Construcción,Inmobiliaria,Casas inteligentes,Gobierno,Bancos,E-commerce,Salud,Logística",
    "homepage.teamLabel": "Equipo",
    "homepage.teamTitle": "6 empresas en un ecosistema",
    "homepage.teamDesc": "Equipo completo de especialistas para cada proyecto",
    "homepage.role1.title": "Consultores de negocio",
    "homepage.role1.text": "Se sumergen en el negocio, analizan procesos, identifican puntos de crecimiento",
    "homepage.role2.title": "Analistas de negocio",
    "homepage.role2.text": "Traducen tareas de negocio a lenguaje técnico, estructuran requisitos",
    "homepage.role3.title": "Ingenieros ML",
    "homepage.role3.text": "Backend, frontend, DevOps, ML. Implementan soluciones técnicas",
    "homepage.role4.title": "Gestores de proyecto",
    "homepage.role4.text": "Coordinan trabajo, supervisan plazos y calidad. Punto de contacto único",
    "homepage.role5.title": "Soporte 24/7",
    "homepage.role5.text": "Monitoreo 24 horas, respuesta rápida, mejoras continuas",
    "homepage.role6.title": "Entrenadores IA",
    "homepage.role6.text": "Entrenan modelos para especificidades del negocio, configuran prompts y escenarios",
    "homepage.expertsLabel": "Expertos clave",
    "homepage.demoLabel": "Demo",
    "homepage.demoTitle": "Escucha al gestor IA en acción",
    "homepage.demoDesc": "Grabaciones reales de llamadas de diferentes industrias",
    "homepage.resultLabel": "Resultado",
    "homepage.testimonialsLabel": "Testimonios",
    "homepage.testimonialsTitle": "Qué dicen los clientes",
    "homepage.testimonialsDesc": "Resultados reales de implementación de soluciones IA",
    "homepage.statsLabel": "Resultados",
    "homepage.statsTitle": "Los números hablan por sí solos",
    "homepage.statsDesc": "Resultados medibles de nuestros clientes",
    "homepage.faqLabel": "FAQ",
    "homepage.faqTitle": "Preguntas frecuentes",
    "homepage.faqDesc": "Respuestas a preguntas populares sobre implementación IA",
    "homepage.finalCtaLabel": "Empieza ahora",
    "homepage.finalCtaTitle": "¿Listo para automatizar ventas?",
  ...
  de: {
    ...
    // Homepage
    "homepage.badge": "KI-Lösungen der nächsten Generation für Unternehmen",
    "homepage.title": "Sprach-KI-Manager, die ",
    "homepage.titleHighlight": "für Sie verkaufen",
    "homepage.subtitle": "Nehmen Anrufe entgegen, bearbeiten Anfragen, erstellen Rechnungen und verwalten CRM. Keine Wochenenden, keine Krankheitstage, keine Fehler. 24/7/365.",
    "homepage.ctaPrimary": "Kostenloses Audit erhalten",
    "homepage.ctaSecondary": "KI in Aktion hören",
    "homepage.trustText": "Kostenlose Beratung · ROI-Berechnung in 15 Min · Ohne Verpflichtungen",
    "homepage.stat1.value": "500+",
    "homepage.stat1.label": "Projekte abgeschlossen",
    "homepage.stat2.value": "10+",
    "homepage.stat2.label": "Jahre am KI-Markt",
    "homepage.stat3.value": "+87%",
    "homepage.stat3.label": "Durchschn. Konversionswachstum",
    "homepage.stat4.value": "98%",
    "homepage.stat4.label": "Zufriedene Kunden",
    "homepage.integrations": "Integrationen",
    "homepage.solutionsLabel": "Lösungen",
    "homepage.solutionsTitle": "KI-Lösungen, die bereits Umsatz generieren",
    "homepage.solutionsDesc": "Jede Lösung wird für Ihre Branche entwickelt, integriert sich in bestehende Systeme und liefert messbare Ergebnisse",
    "homepage.processLabel": "Prozess",
    "homepage.processTitle": "Von der Analyse zum Start in 2-4 Wochen",
    "homepage.processDesc": "Transparenter Prozess mit klaren Phasen. Sie sehen Fortschritte bei jedem Schritt.",
    "homepage.step1.title": "Eintauchen",
    "homepage.step1.desc": "Tiefgehende Analyse der Geschäftsprozesse, Identifizierung von Wachstumspunkten und Zielgruppenanalyse",
    "homepage.step1.dur": "2-3 Tage",
    "homepage.step2.title": "Architektur",
    "homepage.step2.desc": "Szenarioentwicklung, Modellauswahl, Integrationsdesign mit Infrastruktur",
    "homepage.step2.dur": "3-5 Tage",
    "homepage.step3.title": "KI-Training",
    "homepage.step3.desc": "Prompt-Erstellung, Training mit Ihren Daten, Anpassung an Markenstimme",
    "homepage.step3.dur": "5-7 Tage",
    "homepage.step4.title": "Start",
    "homepage.step4.desc": "Pilot, A/B-Tests, Anpassungen, vollständige Bereitstellung mit 24/7-Monitoring",
    "homepage.step4.dur": "2-3 Tage",
    "homepage.capabilitiesLabel": "Fähigkeiten",
    "homepage.capabilitiesTitle": "Was der M2 KI-Manager kann",
    "homepage.capabilitiesDesc": "Neueste Modellgeneration, trainiert für Ihre Branchenspezifika",
    "homepage.cap1.title": "Rechnungserstellung",
    "homepage.cap1.text": "KI erstellt PDF-Rechnungen, erkennt Details und sendet automatisch an Kunden",
    "homepage.cap2.title": "Vollständiger Verkaufstrichter",
    "homepage.cap2.text": "Lead-Qualifizierung, Einwandbehandlung, Präsentation. Konversion bis +87%",
    "homepage.cap3.title": "Alle Kommunikationskanäle",
    "homepage.cap3.text": "Anrufe, E-Mail, SMS, Telegram, WhatsApp. Ein Agent für alle Kanäle",
    "homepage.cap4.title": "CRM-Integration",
    "homepage.cap4.text": "amoCRM, Bitrix24, 1C, SAP. Echtzeit-Datensynchronisierung",
    "homepage.cap5.title": "Beschaffungsautomatisierung",
    "homepage.cap5.text": "KI erstellt Lieferantenbestellungen und verfolgt Lieferstatus",
    "homepage.cap6.title": "Markentraining",
    "homepage.cap6.text": "KI übernimmt Ton, Werte und Standards des Unternehmens für jeden Kunden",
    "homepage.industriesLabel": "Branchen",
    "homepage.industries": "Bau,Immobilien,Smart Homes,Behörden,Banken,E-Commerce,Gesundheit,Logistik",
    "homepage.teamLabel": "Team",
    "homepage.teamTitle": "6 Unternehmen in einem Ökosystem",
    "homepage.teamDesc": "Komplettes Spezialistenteam für jedes Projekt",
    "homepage.role1.title": "Unternehmensberater",
    "homepage.role1.text": "Tauchen ins Geschäft ein, analysieren Prozesse, identifizieren Wachstumspunkte",
    "homepage.role2.title": "Business-Analysten",
    "homepage.role2.text": "Übersetzen Geschäftsaufgaben in technische Sprache, strukturieren Anforderungen",
    "homepage.role3.title": "ML-Ingenieure",
    "homepage.role3.text": "Backend, Frontend, DevOps, ML. Setzen technische Lösungen um",
    "homepage.role4.title": "Projektmanager",
    "homepage.role4.text": "Koordinieren Arbeit, überwachen Fristen und Qualität. Einziger Ansprechpartner",
    "homepage.role5.title": "24/7-Support",
    "homepage.role5.text": "Rund-um-die-Uhr-Überwachung, schnelle Reaktion, kontinuierliche Verbesserungen",
    "homepage.role6.title": "KI-Trainer",
    "homepage.role6.text": "Trainieren Modelle für Geschäftsspezifika, konfigurieren Prompts und Szenarien",
    "homepage.expertsLabel": "Schlüsselexperten",
    "homepage.demoLabel": "Demo",
    "homepage.demoTitle": "Hören Sie den KI-Manager in Aktion",
    "homepage.demoDesc": "Echte Anrufaufzeichnungen aus verschiedenen Branchen",
    "homepage.resultLabel": "Ergebnis",
    "homepage.testimonialsLabel": "Referenzen",
    "homepage.testimonialsTitle": "Was Kunden sagen",
    "homepage.testimonialsDesc": "Echte Ergebnisse der KI-Lösungsimplementierung",
    "homepage.statsLabel": "Ergebnisse",
    "homepage.statsTitle": "Zahlen sprechen für sich",
    "homepage.statsDesc": "Messbare Ergebnisse unserer Kunden",
    "homepage.faqLabel": "FAQ",
    "homepage.faqTitle": "Häufig gestellte Fragen",
    "homepage.faqDesc": "Antworten auf beliebte Fragen zur KI-Implementierung",
    "homepage.finalCtaLabel": "Jetzt starten",
    "homepage.finalCtaTitle": "Bereit, Verkäufe zu automatisieren?",
  ...
  nl: {
    ...
    "hotelConcierge.ai": "AI",
    // Homepage
    "homepage.badge": "Volgende generatie AI-oplossingen voor bedrijven",
    "homepage.title": "Voice AI-managers die ",
    "homepage.titleHighlight": "voor u verkopen",
    "homepage.subtitle": "Nemen oproepen aan, verwerken aanvragen, maken facturen en beheren CRM. Geen weekenden, geen ziektedagen, geen fouten. 24/7/365.",
    "homepage.ctaPrimary": "Gratis audit krijgen",
    "homepage.ctaSecondary": "Luister naar AI in actie",
    "homepage.trustText": "Gratis advies · ROI-berekening in 15 min · Zonder verplichtingen",
    "homepage.stat1.value": "500+",
    "homepage.stat1.label": "Projecten voltooid",
    "homepage.stat2.value": "10+",
    "homepage.stat2.label": "Jaar in AI-markt",
    "homepage.stat3.value": "+87%",
    "homepage.stat3.label": "Gemiddelde conversiegroei",
    "homepage.stat4.value": "98%",
    "homepage.stat4.label": "Tevreden klanten",
    "homepage.integrations": "Integraties",
    "homepage.solutionsLabel": "Oplossingen",
    "homepage.solutionsTitle": "AI-oplossingen die al omzet genereren",
    "homepage.solutionsDesc": "Elke oplossing is ontworpen voor uw branche, integreert met huidige systemen en levert meetbare resultaten",
    "homepage.processLabel": "Proces",
    "homepage.processTitle": "Van analyse naar lancering in 2-4 weken",
    "homepage.processDesc": "Transparant proces met duidelijke fasen. U ziet vooruitgang bij elke stap.",
    "homepage.step1.title": "Verdieping",
    "homepage.step1.desc": "Diepgaande analyse van bedrijfsprocessen, identificatie van groeipunten en doelgroeponderzoek",
    "homepage.step1.dur": "2-3 dagen",
    "homepage.step2.title": "Architectuur",
    "homepage.step2.desc": "Scenario-ontwikkeling, modelselectie, integratieontwerp met infrastructuur",
    "homepage.step2.dur": "3-5 dagen",
    "homepage.step3.title": "AI-training",
    "homepage.step3.desc": "Prompt-creatie, training met uw data, afstemming op merkstem",
    "homepage.step3.dur": "5-7 dagen",
    "homepage.step4.title": "Lancering",
    "homepage.step4.desc": "Pilot, A/B-tests, aanpassingen, volledige uitrol met 24/7-monitoring",
    "homepage.step4.dur": "2-3 dagen",
    "homepage.capabilitiesLabel": "Mogelijkheden",
    "homepage.capabilitiesTitle": "Wat de M2 AI-manager kan",
    "homepage.capabilitiesDesc": "Nieuwste generatie modellen getraind voor uw branche",
    "homepage.cap1.title": "Factuurgeneratie",
    "homepage.cap1.text": "AI maakt PDF-facturen, herkent gegevens en stuurt automatisch naar klant",
    "homepage.cap2.title": "Volledige verkooptrechter",
    "homepage.cap2.text": "Lead-kwalificatie, bezwaarafhandeling, presentatie. Conversie tot +87%",
    "homepage.cap3.title": "Alle communicatiekanalen",
    "homepage.cap3.text": "Oproepen, e-mail, SMS, Telegram, WhatsApp. Één agent voor alle kanalen",
    "homepage.cap4.title": "CRM-integratie",
    "homepage.cap4.text": "amoCRM, Bitrix24, 1C, SAP. Realtime datasynchronisatie",
    "homepage.cap5.title": "Inkoopautomatisering",
    "homepage.cap5.text": "AI maakt leveranciersorders en volgt leveringsstatus",
    "homepage.cap6.title": "Merktraining",
    "homepage.cap6.text": "AI neemt toon, waarden en standaarden van bedrijf over voor elke klant",
    "homepage.industriesLabel": "Branches",
    "homepage.industries": "Bouw,Vastgoed,Smart Homes,Overheid,Banken,E-commerce,Gezondheidszorg,Logistiek",
    "homepage.teamLabel": "Team",
    "homepage.teamTitle": "6 bedrijven in één ecosysteem",
    "homepage.teamDesc": "Compleet team van specialisten voor elk project",
    "homepage.role1.title": "Bedrijfsconsultants",
    "homepage.role1.text": "Verdiepen zich in bedrijf, analyseren processen, identificeren groeipunten",
    "homepage.role2.title": "Bedrijfsanalisten",
    "homepage.role2.text": "Vertalen bedrijfstaken naar technische taal, structureren vereisten",
    "homepage.role3.title": "ML-engineers",
    "homepage.role3.text": "Backend, frontend, DevOps, ML. Implementeren technische oplossingen",
    "homepage.role4.title": "Projectmanagers",
    "homepage.role4.text": "Coördineren werk, bewaken deadlines en kwaliteit. Enig contactpunt",
    "homepage.role5.title": "24/7-ondersteuning",
    "homepage.role5.text": "24-uurs monitoring, snelle respons, continue verbeteringen",
    "homepage.role6.title": "AI-trainers",
    "homepage.role6.text": "Trainen modellen voor bedrijfsspecificaties, configureren prompts en scenario's",
    "homepage.expertsLabel": "Belangrijkste experts",
    "homepage.demoLabel": "Demo",
    "homepage.demoTitle": "Luister naar AI-manager in actie",
    "homepage.demoDesc": "Echte opnames van gesprekken uit verschillende branches",
    "homepage.resultLabel": "Resultaat",
    "homepage.testimonialsLabel": "Getuigenissen",
    "homepage.testimonialsTitle": "Wat klanten zeggen",
    "homepage.testimonialsDesc": "Echte resultaten van AI-oplossingsimplementatie",
    "homepage.statsLabel": "Resultaten",
    "homepage.statsTitle": "Cijfers spreken voor zich",
    "homepage.statsDesc": "Meetbare resultaten van onze klanten",
    "homepage.faqLabel": "FAQ",
    "homepage.faqTitle": "Veelgestelde vragen",
    "homepage.faqDesc": "Antwoorden op populaire vragen over AI-implementatie",
    "homepage.finalCtaLabel": "Begin nu",
    "homepage.finalCtaTitle": "Klaar om verkoop te automatiseren?",
  ...
  fr: {
    ...
    "hotelConcierge.ai": "IA",
    // Homepage
    "homepage.badge": "Solutions IA de nouvelle génération pour les entreprises",
    "homepage.title": "Gestionnaires IA vocaux qui ",
    "homepage.titleHighlight": "vendent pour vous",
    "homepage.subtitle": "Prennent les appels, traitent les demandes, génèrent les factures et gèrent le CRM. Sans week-ends, sans arrêts maladie, sans erreurs. 24/7/365.",
    "homepage.ctaPrimary": "Obtenir un audit gratuit",
    "homepage.ctaSecondary": "Écouter l'IA en action",
    "homepage.trustText": "Consultation gratuite · Calcul ROI en 15 min · Sans engagement",
    "homepage.stat1.value": "500+",
    "homepage.stat1.label": "Projets réalisés",
    "homepage.stat2.value": "10+",
    "homepage.stat2.label": "Années sur le marché IA",
    "homepage.stat3.value": "+87%",
    "homepage.stat3.label": "Croissance moyenne conversion",
    "homepage.stat4.value": "98%",
    "homepage.stat4.label": "Clients satisfaits",
    "homepage.integrations": "Intégrations",
    "homepage.solutionsLabel": "Solutions",
    "homepage.solutionsTitle": "Solutions IA qui génèrent déjà des revenus",
    "homepage.solutionsDesc": "Chaque solution est conçue pour votre secteur, s'intègre aux systèmes actuels et offre des résultats mesurables",
    "homepage.processLabel": "Processus",
    "homepage.processTitle": "De l'analyse au lancement en 2-4 semaines",
    "homepage.processDesc": "Processus transparent avec des étapes claires. Vous voyez les progrès à chaque étape.",
    "homepage.step1.title": "Immersion",
    "homepage.step1.desc": "Analyse approfondie des processus métier, identification des points de croissance et étude du public cible",
    "homepage.step1.dur": "2-3 jours",
    "homepage.step2.title": "Architecture",
    "homepage.step2.desc": "Développement de scénarios, sélection de modèles, conception d'intégrations avec l'infrastructure",
    "homepage.step2.dur": "3-5 jours",
    "homepage.step3.title": "Formation IA",
    "homepage.step3.desc": "Création de prompts, formation sur vos données, ajustement au ton de marque",
    "homepage.step3.dur": "5-7 jours",
    "homepage.step4.title": "Lancement",
    "homepage.step4.desc": "Pilote, tests A/B, ajustements, déploiement complet avec monitoring 24/7",
    "homepage.step4.dur": "2-3 jours",
    "homepage.capabilitiesLabel": "Capacités",
    "homepage.capabilitiesTitle": "Ce que peut faire le gestionnaire IA M2",
    "homepage.capabilitiesDesc": "Modèles de dernière génération formés pour votre secteur",
    "homepage.cap1.title": "Génération de factures",
    "homepage.cap1.text": "L'IA crée des factures PDF, reconnaît les détails et envoie automatiquement au client",
    "homepage.cap2.title": "Entonnoir de vente complet",
    "homepage.cap2.text": "Qualification des leads, traitement des objections, présentation. Conversion jusqu'à +87%",
    "homepage.cap3.title": "Tous les canaux de communication",
    "homepage.cap3.text": "Appels, email, SMS, Telegram, WhatsApp. Un seul agent pour tous les canaux",
    "homepage.cap4.title": "Intégration CRM",
    "homepage.cap4.text": "amoCRM, Bitrix24, 1C, SAP. Synchronisation des données en temps réel",
    "homepage.cap5.title": "Automatisation des achats",
    "homepage.cap5.text": "L'IA génère les commandes fournisseurs et suit le statut des livraisons",
    "homepage.cap6.title": "Formation de marque",
    "homepage.cap6.text": "L'IA adopte le ton, les valeurs et les standards de l'entreprise pour chaque client",
    "homepage.industriesLabel": "Secteurs",
    "homepage.industries": "Construction,Immobilier,Maisons intelligentes,Gouvernement,Banques,E-commerce,Santé,Logistique",
    "homepage.teamLabel": "Équipe",
    "homepage.teamTitle": "6 entreprises dans un écosystème",
    "homepage.teamDesc": "Équipe complète de spécialistes pour chaque projet",
    "homepage.role1.title": "Consultants d'affaires",
    "homepage.role1.text": "S'immergent dans l'entreprise, analysent les processus, identifient les points de croissance",
    "homepage.role2.title": "Analystes d'affaires",
    "homepage.role2.text": "Traduisent les tâches métier en langage technique, structurent les exigences",
    "homepage.role3.title": "Ingénieurs ML",
    "homepage.role3.text": "Backend, frontend, DevOps, ML. Implémentent les solutions techniques",
    "homepage.role4.title": "Chefs de projet",
    "homepage.role4.text": "Coordonnent le travail, surveillent les délais et la qualité. Point de contact unique",
    "homepage.role5.title": "Support 24/7",
    "homepage.role5.text": "Surveillance 24h, réponse rapide, améliorations continues",
    "homepage.role6.title": "Formateurs IA",
    "homepage.role6.text": "Forment les modèles aux spécificités métier, configurent les prompts et scénarios",
    "homepage.expertsLabel": "Experts clés",
    "homepage.demoLabel": "Démo",
    "homepage.demoTitle": "Écoutez le gestionnaire IA en action",
    "homepage.demoDesc": "Enregistrements réels d'appels de différents secteurs",
    "homepage.resultLabel": "Résultat",
    "homepage.testimonialsLabel": "Témoignages",
    "homepage.testimonialsTitle": "Ce que disent les clients",
    "homepage.testimonialsDesc": "Résultats réels de l'implémentation des solutions IA",
    "homepage.statsLabel": "Résultats",
    "homepage.statsTitle": "Les chiffres parlent d'eux-mêmes",
    "homepage.statsDesc": "Résultats mesurables de nos clients",
    "homepage.faqLabel": "FAQ",
    "homepage.faqTitle": "Questions fréquentes",
    "homepage.faqDesc": "Réponses aux questions populaires sur l'implémentation IA",
    "homepage.finalCtaLabel": "Commencez maintenant",
