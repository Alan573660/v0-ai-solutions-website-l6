...
export function RobotDlyaZvonkovPage({ locale }: RobotDlyaZvonkovPageProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 bg-gradient-to-r from-blue-50/20 to-cyan-50/20 dark:from-blue-950/20 dark:to-cyan-950/20 border-t border-slate-200 dark:border-slate-800">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center justify-between gap-4">
            ...
            <Button asChild variant="ghost" className="text-blue-400 hover:text-blue-300 shrink-0">
