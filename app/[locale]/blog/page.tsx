...
export default async function BlogPage({ params }: BlogPageProps) {
  ...
  const posts = [
    {
      id: "ai-chatbots-customer-service-2025",
      title: "AI-чатботы для клиентского сервиса 2025: Полное руководство",
      excerpt:
        "Узнайте, как AI-чатботы революционизируют клиентский сервис в 2025 году. Автоматизация поддержки, снижение затрат на 60% и повышение удовлетворенности клиентов. Практическое руководство по внедрению.",
      ...
      seoDescription:
        "Полное руководство по AI-чатботам для клиентского сервиса 2025: автоматизация поддержки, снижение затрат на 60%, повышение удовлетворенности клиентов.",
    },
    {
      id: "voice-ai-real-estate-property-sales",
      title: "Голосовой AI в недвижимости: Автоматизация продаж объектов",
      excerpt:
        "Как голосовые AI-ассистенты трансформируют рынок недвижимости: автоматизация показов, квалификация лидов 24/7 и увеличение конверсии на 45%. Реальные кейсы и ROI.",
      ...
      seoDescription:
        "Как голосовые AI-ассистенты трансформируют рынок недвижимости: автоматизация показов, квалификация лидов 24/7, рост конверсии на 45%.",
    },
    {
      id: "ai-powered-crm-sales-automation",
      title: "AI-powered CRM: Автоматизация продаж нового поколения",
      excerpt:
        "Интеллектуальная CRM с AI: автоматическое ведение сделок, предиктивная аналитика и персонализация коммуникаций. Увеличение продаж на 50% с AI-powered CRM системами.",
      ...
      seoDescription:
        "Интеллектуальная CRM с AI: автоматическое ведение сделок, предиктивная аналитика, персонализация. Рост продаж на 50%.",
    },
    {
