        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-4 sm:space-y-6">
            ...
            <p className="text-lg sm:text-xl text-purple-100 text-pretty leading-relaxed">
              В нашей команде собраны ведущие эксперты из России, Украины, Казахстана, Беларуси, Индии и других стран.
              Вместе мы создаем голосовые AI-решения, которые трансформируют бизнес по всему миру.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                Демократизировать передовые технологии голосового ИИ, делая их доступными для бизнеса любого размера в
                странах СНГ, Европе и по всему миру. Мы верим, что каждая компания должна иметь возможность
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 sm:p-6 rounded-lg border border-purple-200">
                ...
                <p className="text-sm sm:text-base text-purple-800 leading-relaxed">
                  <strong>Международная команда мирового уровня:</strong> В AI Solutions работают лучшие специалисты из
                  России (Яндекс, Mail.ru, Сбербанк), Украины (Grammarly, Preply), Казахстана (Kaspi, Beeline), Беларуси
                  (EPAM, PandaDoc), Индии (Google, Microsoft), Армении (Picsart) и других стран СНГ.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-4 sm:space-y-6">
            ...
            <p className="text-base sm:text-lg md:text-xl text-purple-100 leading-relaxed">
              Хотите ли вы трансформировать свой бизнес с помощью наших решений или присоединиться к нашей международной
              команде экспертов, мы будем рады услышать от вас
            </p>
          </div>
        </div>
      </section>
