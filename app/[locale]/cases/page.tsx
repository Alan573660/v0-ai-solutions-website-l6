...
export async function generateMetadata({ params }: CasesPageProps): Promise<Metadata> {
  ...
  const title =
    locale === "ru"
      ? "Кейсы внедрения AI Solutions - Истории успеха клиентов | Сбербанк, Магнит, Аэрофлот"
      : "AI Solutions Case Studies - Client Success Stories | Sberbank, Magnit, Aeroflot"

  const description =
    locale === "ru"
      ? "Реальные кейсы внедрения голосовых AI-ассистентов в крупнейших компаниях России: Сбербанк (+350% эффективности), Магнит (+42% продаж), Аэрофлот (24/7 поддержка). 100+ успешных проектов в банках, ритейле, госсекторе."
      : "Real case studies of voice AI assistants implementation in Russia's largest companies: Sberbank (+350% efficiency), Magnit (+42% sales), Aeroflot (24/7 support). 100+ successful projects in banking, retail, government."
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "/modern-bank-interior-with-ai-assistant-technology.jpg",
          width: 1200,
          height: 630,
          alt: title,
        },
    ...
    twitter: {
      ...
      title,
      description,
      images: ["/modern-bank-interior-with-ai-assistant-technology.jpg"],
    },
    alternates: {
...
export default async function CasesPage({ params }: CasesPageProps) {
  ...
  const collectionPageSchema = {
    ...
    "@type": "CollectionPage",
    "@id": `https://ai-solutions.ru/${locale}/cases#collectionpage`,
    name: locale === "ru" ? "Кейсы внедрения AI Solutions" : "AI Solutions Case Studies",
    description:
      locale === "ru"
        ? "Коллекция успешных проектов внедрения голосовых AI-ассистентов в различных отраслях: банки, ритейл, госсектор, авиация, телеком, энергетика."
        : "Collection of successful voice AI assistant implementation projects across industries: banking, retail, government, aviation, telecom, energy.",
    breadcrumb: {
      "@type": "BreadcrumbList",
      itemListElement: [
        {
        ...
        },
        {
          "@type": "ListItem",
          position: 2,
          name: locale === "ru" ? "Кейсы" : "Cases",
          item: `https://ai-solutions.ru/${locale}/cases`,
        },
      ],
    },
    mainEntity: {
      ...
      itemListElement: cases.map((case_, index) => ({
        "@type": "Article",
        position: index + 1,
