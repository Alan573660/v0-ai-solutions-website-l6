...
function generateJsonLd(locale: Locale) {
  const data = {
    ru: {
      ...
      intro: "Голосовой AI-менеджер — это интеллектуальная система автоматизации звонков, которая заменяет операторов колл-центра. Система работает круглосуточно и способна обрабатывать тысячи звонков одновременно.",
      capabilities: [
