...
const translations = {
  ru: {
    ...
    architecture: {
      ...
      layers: [
        { icon: "headphones", title: "Слой телефонии", desc: "Интеграция с любыми АТ��, SIP-провайдерами, виртуальными номерами" },
    ...
    future: {
      ...
      features: [
        ...
        { icon: "messageSquare", title: "Анали�� разговоров", desc: "Транскрипция и оценка качества" },
