          ...
          <Reveal>
            <div className="flex flex-wrap justify-center gap-3">
              {integrations.map((item) => (
                <div key={item.name} className="group px-5 py-3 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm font-medium hover:border-violet-500/50 hover:bg-violet-50 dark:hover:bg-violet-900/20 transition-all cursor-default shadow-sm">
